package com.ls.vbuynet.service.provider.search.api.impl;
...
public class SearchSolrServiceImpl implements SearchSolrService {
    ...
    public List<Product> search(String query, int page, int rows) {
        List<Product> searchResults = Lists.newArrayList();
        ...
        try {
            ...
            for (SolrDocument solrDocument : solrDocuments) {
                ...
                product.setId((long)Integer.parseInt(String.valueOf(solrDocument.get("id"))));
...
//                product.setTbItemTitle(tbItemTitle);
